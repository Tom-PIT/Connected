...
namespace TomPIT.Design
{
    internal class VersionControl : TenantObject, IVersionControl
    {
        ...
        {
            return Instance.SysProxy.Development.VersionControl.QueryChanges(Guid.Empty, Guid.Empty).ToList();
        }

        public void DeleteHistory(Guid component)
        {
            Instance.SysProxy.Development.VersionControl.DeleteHistory(component);
        }

        public ICommit SelectCommit(Guid token)
        {
            return Instance.SysProxy.Development.VersionControl.SelectCommit(token);
        }

        public IComponentHistory SelectNonCommited(Guid component)
        {
            return Instance.SysProxy.Development.VersionControl.SelectNonCommited(component);
        }

        public List<IComponent> Changes(Guid microService)
        {
            return Instance.SysProxy.Development.VersionControl.QueryChanges(microService, Guid.Empty).ToList();
        }

        public List<IComponent> Changes(Guid microService, Guid user)
        {
            return Instance.SysProxy.Development.VersionControl.QueryChanges(microService, user).ToList();
        }

        public void Commit(List<Guid> components, string comment)
        {
            Instance.SysProxy.Development.VersionControl.Commit(MiddlewareDescriptor.Current.UserToken, components, comment);
        }
        ...
        public void DeleteCommit(Guid token)
        {
            ...
            Instance.SysProxy.Development.VersionControl.DeleteCommit(token);
        }

        public ILockInfo SelectLockInfo(Guid component)
        {
            return Instance.SysProxy.Development.VersionControl.SelectLockInfo(MiddlewareDescriptor.Current.UserToken, component);
        }

        public List<IComponent> QueryCommitComponents(Guid commit)
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommitComponents(commit).ToList();
        }

        public List<ICommit> QueryCommits()
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommits(Guid.Empty, Guid.Empty).ToList();
        }

        public List<ICommit> LookupCommits(List<Guid> tokens)
        {
            return Instance.SysProxy.Development.VersionControl.LookupCommits(tokens).ToList();
        }

        public List<ICommit> QueryCommits(Guid microService)
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommits(microService, Guid.Empty).ToList();
        }

        public List<ICommit> QueryCommits(Guid microService, Guid user)
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommits(microService, user).ToList();
        }

        public List<ICommit> QueryCommitsForComponent(Guid microService, Guid component)
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommitsForComponent(microService, component).ToList();
        }
        ...
        public void Rollback(Guid commit, Guid component)
        {
            ...
            foreach (var i in comps)
            {
                ...
                Instance.SysProxy.Development.VersionControl.Undo(component);
            }
        }
        ...
        public void Undo(List<Guid> components)
        {
            foreach (var i in components)
            {
                ...
                Instance.SysProxy.Development.VersionControl.Undo(i);
        ...
        public void Lock(Guid component, LockVerb verb)
        {
            ...
            Instance.SysProxy.Development.VersionControl.Lock(MiddlewareDescriptor.Current.UserToken, component, blob, verb);
        }
        ...
        public List<IComponentHistory> QueryHistory(Guid component)
        {
            ...
            try
            {
                return Instance.SysProxy.Development.VersionControl.QueryHistory(component).ToList();
            }
            catch
            {
        ...
        {
            var history = Instance.SysProxy.Development.VersionControl.QueryMicroServiceHistory(microService);
            var checkout = Instance.SysProxy.Development.VersionControl.QueryCheckout(microService);
        ...
        {
            return Instance.SysProxy.Development.VersionControl.QueryCommitDetails(commit).ToList();
        }

        public IComponentHistory SelectCommitDetail(Guid commit, Guid component)
        {
            return Instance.SysProxy.Development.VersionControl.SelectCommitDetail(commit, component);
        }
