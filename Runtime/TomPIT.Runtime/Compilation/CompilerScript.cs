    ...
    internal class CompilerScript : TenantObject, IDisposable
    {
        ...
        private string GenerateStaticCode()
        {
            ...
            foreach (var file in ScriptContext.SourceFiles)
            {
                ...
                {
                    sb.AppendLine($"new TomPIT.Compilation.SourceTypeDescriptor{{Component=new System.Guid(\"{component.Token}\"), ContainingType = \"{manifestType.ContainingType}\", TypeName=\"{manifestType.Name}\"}},");
                }
            }
