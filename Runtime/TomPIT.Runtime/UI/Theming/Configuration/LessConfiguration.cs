namespace TomPIT.UI.Theming.Configuration
{
	using System;
	...
	public enum LessSessionStateMode
    {
        /// <summary>
        ///  Session is not used.
        /// </summary>
        ...
        /// <summary>
        ///  Session is loaded when URL QueryString parameter specified by <seealso cref="LessConfiguration.SessionQueryParamName"/> is truthy.
        /// </summary>
        QueryParam
    }
    ...
    public class LessConfiguration
    {
        ...
        public static LessConfiguration GetDefault()
        {
            return new LessConfiguration();
        }

        public static LessConfiguration GetDefaultWeb()
        {
            return new LessConfiguration
            {
                Web = true
        ...
        public LessConfiguration()
        {
            ...
            Web = false;
            SessionMode = LessSessionStateMode.Disabled;
        ...
        public LessConfiguration(LessConfiguration config)
        {
        ...
        /// </summary>
        public LessSessionStateMode SessionMode { get; set; }

        /// <summary>
        ///  Gets or sets the URL QueryString parameter name used in conjunction with <seealso cref="SessionMode"/> set to <seealso cref="LessSessionStateMode.QueryParam"/>.
        /// </summary>
