namespace TomPIT.UI.Theming.Utils
{
	using System;
	using System.Linq;
	using Parser.Tree;

	public class ThemeHslColor
    {
        ...
        public ThemeHslColor(double hue, double saturation, double lightness)
            : this(hue, saturation, lightness, 1)
        {
        }

        public ThemeHslColor(double hue, double saturation, double lightness, double alpha)
        {
            Hue = hue;
        ...
        public ThemeHslColor(Number hue, Number saturation, Number lightness, Number alpha)
        {
        ...
        public static ThemeHslColor FromRgbColor(Color color)
        {
            ...
            return new ThemeHslColor(hue, saturation, lightness, color.Alpha);
        }
