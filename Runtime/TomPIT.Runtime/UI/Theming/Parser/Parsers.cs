...
namespace TomPIT.UI.Theming.Parser
{
	...
	public class Parsers
    {
        ...
        //
        public NodeList Primary(LessParser parser)
        {
            Node node;
        ...
        /// </summary>
        private void GatherComments(LessParser parser)
        {
            Comment comment;
        ...
        /// </summary>
        private NodeList GatherAndPullComments(LessParser parser)
        {
            GatherComments(parser);
            return PullComments();
        }
        ...
        // over them.e
        public Comment Comment(LessParser parser)
        {
        ...
        //
        public Quoted Quoted(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
            var escaped = false;
        ...
        //
        public Keyword Keyword(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        //
        public Call Call(LessParser parser)
        {
        ...
        public NodeList<Node> Arguments(LessParser parser)
        {
        ...
        //
        public Assignment Assignment(LessParser parser)
        {
        ...
        public Node Literal(LessParser parser)
        {
        ...
        //
        public Url Url(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        //
        public Variable Variable(LessParser parser)
        {
        ...
        //     [@{foo}="value"]
        //
        public Variable InterpolatedVariable(LessParser parser) {
            RegexMatchResult name;
            var index = parser.Tokenizer.Location.Index;
        ...
        //     }
        //
        public Variable VariableCurly(LessParser parser)
        {
            RegexMatchResult name;
            var index = parser.Tokenizer.Location.Index;
        ...
        ///    }
        /// 
        public GuardedRuleset GuardedRuleset(LessParser parser)
        {
        ...
        /// <returns></returns>
        public Extend ExtendRule(LessParser parser)
        {
        ...
        //
        public Color Color(LessParser parser)
        {
        ...
        //     0.5em 95%
        //
        public Number Dimension(LessParser parser)
        { 
        ...
        //     ``
        //
        public Script Script(LessParser parser)
        {
            if (parser.Tokenizer.CurrentChar != '`')
                return null;
        ...
        //     @fink:
        //
        public string VariableName(LessParser parser)
        {
        ...
        //
        public Shorthand Shorthand(LessParser parser)
        {
        ...
        // selector for now.
        //
        public MixinCall MixinCall(LessParser parser)
        {
        ...
        private Expression Expression(LessParser parser, bool allowList)
        {
        ...
        // the `{...}` block.
        //
        public MixinDefinition MixinDefinition(LessParser parser)
        {
        ...
        /// </summary>
        public Condition Conditions(LessParser parser)
        {
        ...
        /// </summary>
        public Condition Condition(LessParser parser)
        {
        ...
        //
        public Node Entity(LessParser parser)
        {
            return Literal(parser) || Variable(parser) || Url(parser) ||
                   Call(parser) || Keyword(parser) || Script(parser);
        }

        private Expression ExpressionOrExpressionList(LessParser parser)
        {
            var memo = Remember(parser);
        ...
        public bool End(LessParser parser)
        {
        ...
        //     alpha(opacity=88)
        //
        public Alpha Alpha(LessParser parser)
        {
            Node value;
        ...
        //
        public Element Element(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        private static RegexMatchResult PseudoClassSelector(LessParser parser) {
            return parser.Tokenizer.Match(@":(\\.|[a-zA-Z0-9_-])+");
        }

        private static RegexMatchResult PseudoElementSelector(LessParser parser) {
            return parser.Tokenizer.Match(@"::(\\.|[a-zA-Z0-9_-])+");
        }

        private Node NonPseudoClassSelector(LessParser parser) {
            var memo = Remember(parser);
        ...
        //
        public Combinator Combinator(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        //
        public Selector Selector(LessParser parser)
        {
            Element e;
            int realElements = 0;
        ...
        public Node Tag(LessParser parser)
        {
            return parser.Tokenizer.Match(@"[a-zA-Z][a-zA-Z-]*[0-9]?") || parser.Tokenizer.Match('*');
        }

        public Node Attribute(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        //
        public NodeList Block(LessParser parser)
        {
            if (!parser.Tokenizer.Match('{'))
                return null;
        ...
        // div, .class, body > p {...}
        //
        public Ruleset Ruleset(LessParser parser)
        {
            var selectors = new NodeList<Selector>();
        ...
        public Rule Rule(LessParser parser)
        {
            var memo = Remember(parser);
            PushComments();
        ...
        private CssFunctionList FilterExpressionList(LessParser parser)
        {
        ...
        private Node FilterExpression(LessParser parser)
        {
        ...
        //
        public Import Import(LessParser parser)
        {
        ...
        private static ImportOptions ParseOptions(LessParser parser)
        {
            var index = parser.Tokenizer.Location.Index;
        ...
        private static void CheckForConflictingOptions(LessParser parser, ImportOptions options, string allKeywords, int index)
        {
        ...
        //     @charset "utf-8";
        //
        public Node Directive(LessParser parser)
        {
            if (parser.Tokenizer.CurrentChar != '@')
                return null;
        ...
        public Expression MediaFeature(LessParser parser)
        {
        ...
        public Value MediaFeatures(LessParser parser)
        {
        ...
        public Media Media(LessParser parser)
        {
        ...
        public Directive KeyFrameBlock(LessParser parser, string name, string identifier, int index)
        {
            if (!parser.Tokenizer.Match('{'))
                return null;
        ...
        public Value Font(LessParser parser)
        {
        ...
        // and before the `;`.
        //
        public Value Value(LessParser parser)
        {
        ...
        public string Important(LessParser parser)
        {
        ...
        public string IESlash9Hack(LessParser parser)
        {
            var slashNine = parser.Tokenizer.Match(@"\\9");
            return slashNine == null ? "" : slashNine.Value;
        }

        public Expression Sub(LessParser parser)
        {
            if (!parser.Tokenizer.Match('('))
                return null;
        ...
        public Node Multiplication(LessParser parser)
        {
            GatherComments(parser);
        ...
        public Node UnicodeRange(LessParser parser)
        {
        ...
        public Node Operation(LessParser parser)
        {
        ...
        //
        public Node Operand(LessParser parser)
        {
        ...
        //     @var * 2
        //
        public Expression Expression(LessParser parser)
        {
            Node e;
        ...
        public string Property(LessParser parser)
        {
        ...
        public void Expect(LessParser parser, char expectedString)
        {
            Expect(parser, expectedString, null);
        }

        public void Expect(LessParser parser, char expectedString, string message)
        {
        ...
        public T Expect<T>(T node, string message, LessParser parser) where T:Node
        {
            if (node)
                return node;
        ...
        public ParserLocation Remember(LessParser parser)
        {
            return new ParserLocation() { Comments = CurrentComments, TokenizerLocation = parser.Tokenizer.Location };
        }

        public void Recall(LessParser parser, ParserLocation location)
        {
