   ...
   public class Env
    {
        ...
        public LessParser Parser { get; set; }

        public Env() : this(new LessParser())
        {
        }

        public Env(LessParser parser) : this(parser, null, null)
        {
        }

        protected Env(LessParser parser, Stack<Ruleset> frames, Dictionary<string, Type> functions) : this(frames, functions) {
            Parser = parser;
        }
