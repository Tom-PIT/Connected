	...
	public class MicroServicesTemplate : MicroServiceTemplate
	{
		...
		static MicroServicesTemplate()
		{
			_items = new ConcurrentDictionary<string, IItemDescriptor>(new Dictionary<string, IItemDescriptor>
			{
				...
				{ ComponentCategories.Static,           new ItemDescriptor("Static",            ComponentCategories.Static,             typeof(StaticResource))                      { Glyph = "fal fa-images",             Category = "Resources" ,      Ordinal=401} } ,
				{ ComponentCategories.NuGetPackage,new ItemDescriptor("NuGet package",ComponentCategories.NuGetPackage,  typeof(NuGetPackageResource))            { Glyph = "fal fa-cube",          Category = "Resources" ,      Ordinal=402 }  } ,
