...
namespace TomPIT.MicroServices.Design
{
	public class MicroServicesTemplate : MicroServiceTemplate
	{
		...
		static MicroServicesTemplate()
		{
			...
			{
				{ ComponentCategories.View,            new ItemDescriptor("View",             ComponentCategories.View,              typeof(View))                                { Glyph = "fal fa-window-maximize",    Category = "UI",              Ordinal=0 } },
				{ ComponentCategories.MasterView,      new ItemDescriptor("Master view",      ComponentCategories.MasterView,        typeof(MasterView))                          { Glyph = "fal fa-window",             Category = "UI",              Ordinal=1 } },
				{ ComponentCategories.Partial,         new ItemDescriptor("Partial view",     ComponentCategories.Partial,           typeof(Partial))                             { Glyph = "fal fa-window-restore",     Category = "UI" ,             Ordinal=2} },
				...
				{ ComponentCategories.ScriptBundle,    new ItemDescriptor("Script bundle",    ComponentCategories.ScriptBundle,      typeof(ScriptBundle))                        { Glyph = "fal fa-file-code",                 Category = "UI",              Ordinal=4 } },
				...
				{ ComponentCategories.UIDependencyInjection,     new ItemDescriptor("UI Dependency Injection",     ComponentCategories.UIDependencyInjection,       typeof(UIDependencyInjectionConfiguration))            { Glyph = "fal fa-file-code",          Category = "UI" ,     Ordinal=6} },
				{ ComponentCategories.Model,             new ItemDescriptor("Model",              ComponentCategories.Model,               typeof(Model))                                 { Glyph = "fal fa-file-code",    Category = "Middleware" ,     Ordinal=100} },
				{ ComponentCategories.Api,             new ItemDescriptor("Api",              ComponentCategories.Api,               typeof(Api))                                 { Glyph = "fal fa-broadcast-tower",    Category = "Middleware" ,     Ordinal=101} },
