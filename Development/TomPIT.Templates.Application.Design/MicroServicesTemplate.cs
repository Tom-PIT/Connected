...
namespace TomPIT.MicroServices.Design
{
	public class MicroServicesTemplate : MicroServiceTemplate
	{
		...
		static MicroServicesTemplate()
		{
			...
			{
				{ ComponentCategories.View,            new ItemDescriptor("View",             ComponentCategories.View,              typeof(View))                                { Glyph = "fal fa-browser",            Category = "UI",              Ordinal=0 } },
				{ ComponentCategories.MasterView,      new ItemDescriptor("Master view",      ComponentCategories.MasterView,        typeof(MasterView))                          { Glyph = "fal fa-browser",            Category = "UI",              Ordinal=1 } },
				{ ComponentCategories.Partial,         new ItemDescriptor("Partial view",     ComponentCategories.Partial,           typeof(Partial))                             { Glyph = "fal fa-browser",            Category = "UI" ,             Ordinal=2} },
				{ ComponentCategories.Theme,           new ItemDescriptor("Theme",            ComponentCategories.Theme,             typeof(Theme))                               { Glyph = "fal fa-pencil-paintbrush",  Category = "UI" ,             Ordinal=3} },
				{ ComponentCategories.ScriptBundle,    new ItemDescriptor("Script bundle",    ComponentCategories.ScriptBundle,      typeof(ScriptBundle))                        { Glyph = "fab fa-js",                 Category = "UI",              Ordinal=4 } },
				...
				{ ComponentCategories.Script,          new ItemDescriptor("Script",           ComponentCategories.Script,            typeof(Script))                              { Glyph = "fal fa-file-code",          Category = "Middleware" ,     Ordinal=102} },
				{ ComponentCategories.EventHandler,    new ItemDescriptor("Event handler",    ComponentCategories.EventHandler,      typeof(MicroServices.Messaging.EventHandler)){ Glyph = "fal fa-bullseye-pointer",   Category = "Middleware" ,     Ordinal=104} },
				{ ComponentCategories.FeatureSet,      new ItemDescriptor("Feature set",      ComponentCategories.FeatureSet,        typeof(FeatureSet))                          { Glyph = "fal fa-function",           Category = "Middleware" ,     Ordinal=105} },
				...
				{ ComponentCategories.Queue,           new ItemDescriptor("Queue handler",    ComponentCategories.Queue,             typeof(QueueHandlerConfiguration))           { Glyph = "fal fa-cog",                Category = "Distributed" ,    Ordinal=207} },
