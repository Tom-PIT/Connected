	...
	public class MicroServicesTemplate : MicroServiceTemplate
	{
		...
		static MicroServicesTemplate()
		{
			_items = new ConcurrentDictionary<string, IItemDescriptor>(new Dictionary<string, IItemDescriptor>
			{
				...
				{ ComponentCategories.IoCEndpoint,     new ItemDescriptor("IoC Endpoint",     ComponentCategories.IoCEndpoint,       typeof(IoCEndpointConfiguration))            { Glyph = "fal fa-file-code text-success",          Category = "Middleware" ,     Ordinal=104} },
