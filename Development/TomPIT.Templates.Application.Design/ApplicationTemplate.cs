	...
	public class ApplicationTemplate : MicroServiceTemplate
	{
		...
		static ApplicationTemplate()
		{
			_items = new ConcurrentDictionary<string, IItemDescriptor>(new Dictionary<string, IItemDescriptor>{
                ...
                {Script.ComponentCategory, new ItemDescriptor("Script", Script.ComponentCategory, typeof(Script)) { Glyph = "fal fa-file-code", Category = "Model" , Ordinal=101} },
                { Library.ComponentCategory, new ItemDescriptor("Library", Library.ComponentCategory, typeof(Library)) { Glyph = "fal fa-file-code", Category = "Model" , Ordinal=102} },
				{Events.EventHandler.ComponentCategory, new ItemDescriptor("Event handler", Events.EventHandler.ComponentCategory, typeof(Events.EventHandler)) { Glyph = "fal fa-bullseye-pointer", Category = "Model" , Ordinal=103} },
				{DistributedEvent.ComponentCategory, new ItemDescriptor("Distributed event", DistributedEvent.ComponentCategory, typeof(DistributedEvent)) { Glyph = "fal fa-chart-network", Category = "Model" , Ordinal=104} },
				{HostedWorker.ComponentCategory, new ItemDescriptor("Hosted worker", HostedWorker.ComponentCategory, typeof(HostedWorker)) { Glyph = "fal fa-cog", Category = "Model" , Ordinal=105} },
