...
{
	internal class NuGetPackageEmbeddedDesigner : DomDesigner<ReflectionElement>, IUploadDesigner
	{
		public NuGetPackageEmbeddedDesigner(ReflectionElement element) : base(element)
		{
