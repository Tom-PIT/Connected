...
{
	internal class NavigationContextProvider : CompletionProvider
	{
		protected override List<ICompletionItem> OnProvideItems()
		{
			var keys = Editor.Context.Tenant.GetService<INavigationDesignService>().QueryNavigationContexts(Editor.Context.MicroService.Token);
