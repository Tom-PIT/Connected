...
namespace TomPIT.Design.Designers
{
    public class PermissionsDesigner : DomDesigner<IPermissionElement>
    {
        ...
        private IDesignerActionResult Reset(JObject data)
        {
            ...
            Instance.SysProxy.Management.Security.Reset(SelectedSchema, SelectedClaim, Owner.PrimaryKey, null);
        ...
        private IDesignerActionResult SetPermission(JObject data)
        {
            ...
            var value = Instance.SysProxy.Management.Security.SetPermission(evidence.ToString(), SelectedSchema, SelectedClaim, Owner.PermissionDescriptor.Id, Owner.PrimaryKey, Owner.ResourceGroup, Owner.PermissionComponent).ToString();
            _permissions = null;
