...
{
	internal class CSharpCodeLensContext : CSharpCodeAnalyzer<CodeLensArgs>
	{
		private ICodeLens _codelens = null;

		public CSharpCodeLensContext(IMiddlewareContext context, CodeLensArgs e) : base(context, e)
		{
		}
