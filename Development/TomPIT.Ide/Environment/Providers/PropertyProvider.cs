...
{
    internal class PropertyProvider : EnvironmentObject, IPropertyProvider
    {
        ...
        private void DiscoverProperty(object instance, Property val, PropertyInfo property)
        {
            ...
            if (cat != null)
                val.Category = SR.ResourceManager.GetString(cat.Category);
            ...
            if (display != null)
            {
                ...
                val.Text = Types.InsertSpaces(property.Name);
        ...
        private void SetupPropertyEditor(PropertyInfo pi, Property value)
        {
            ...
            else
            {
                ...
                {
                    editor = Element.Environment.Context.Tenant.GetService<IDesignerService>().GetPropertyEditor(att.Name);
        ...
        {
            return Environment.Context.Tenant.GetService<IDesignerService>().GetPropertyEditor(name);
        }
        ...
        private IPropertyEditor FindEditorByType(PropertyInfo pi)
        {
            ...
            else if (pi.PropertyType == typeof(SKColor))
