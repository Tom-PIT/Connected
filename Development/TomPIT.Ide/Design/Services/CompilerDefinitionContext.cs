...
{
	internal class CompilerDefinitionContext : Analyzer<CodeStateArgs>
	{
		private ILocation _hover = null;

		public CompilerDefinitionContext(IExecutionContext context, CodeStateArgs e) : base(context, e)
		{
		}
