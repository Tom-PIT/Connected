...
namespace TomPIT.BigData.Transactions
{
    internal class Updater : IUpdateProvider
    {
        ...
        public void Execute()
        {
            ...
            Parallel.ForEach(Data,
                (f) =>
                {
                    ...
                    {
                        var middlewareType = MiddlewareDescriptor.Current.Tenant.GetService<ICompilerService>().ResolveType(MicroService.Token, Configuration, Configuration.ComponentName());
        ...
        private void OnInvoked(Type middlewareType, IList payload)
        {
            ...
            var middleware = MiddlewareDescriptor.Current.Tenant.GetService<ICompilerService>().CreateInstance<MiddlewareComponent>(ctx, middlewareType);
