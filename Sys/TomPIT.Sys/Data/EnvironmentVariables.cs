...
{
	internal class EnvironmentVariables : SynchronizedRepository<IEnvironmentVariable, string>
	{
		public EnvironmentVariables(IMemoryCache container) : base(container, "environmentvars")
		{
		}
