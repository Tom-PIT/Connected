...
{
	public class MessageRecipientsModel : IdentityRepository<IRecipient, string>
	{
		...
		public void Load(Guid message)
		{
			...
			{
				/*
         * No message to load subscribers for.
         * TODO: Log message for posteriority.
             */
				return;
			}
		...
		public ImmutableList<IRecipient> QueryScheduled()
		{
			...
			foreach (var i in ds)
			{
				...
				{
					DataModel.Messages.Delete(i.Message);
					continue;
				}
