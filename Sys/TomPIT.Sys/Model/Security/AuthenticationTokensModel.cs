...
{
	public class AuthenticationTokensModel : SynchronizedRepository<IAuthenticationToken, Guid>
	{
		public AuthenticationTokensModel(IMemoryCache container) : base(container, "authtokens")
		{
		}
