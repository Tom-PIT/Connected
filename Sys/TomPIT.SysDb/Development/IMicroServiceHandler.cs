...
namespace TomPIT.SysDb.Development
{
	public interface IMicroServiceHandler
	{
		...
		void Update(IMicroService microService, string name, string url, MicroServiceStatus status, Guid template, IResourceGroup resourceGroup, Guid package, Guid plan,
