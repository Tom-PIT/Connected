...
namespace TomPIT.SysDb.Workers
{
	...
	{
		void Insert(Guid microService, Guid api, Guid operation, DateTime startTime, DateTime endTime, WorkerInterval interval, int intervalValue, DateTime startDate, DateTime endDate, int limit,
		...
		IScheduledJob Select(Guid microService, Guid api, Guid operation);
