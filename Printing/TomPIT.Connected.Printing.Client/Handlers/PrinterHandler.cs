...
namespace TomPIT.Connected.Printing.Client.Handlers
{
    internal class PrinterHandler
    {
        ...
        //        printServer = new PrintServer(printerServerName, PrintSystemDesiredAccess.EnumerateServer);
        //    }
        //    else
        //    {
        //        printServer = new PrintServer(PrintSystemDesiredAccess.EnumerateServer);
        //    }
        ...
        //    return !(printQueue.IsOffline || printQueue.IsInError || printQueue.IsNotAvailable);
        //}
