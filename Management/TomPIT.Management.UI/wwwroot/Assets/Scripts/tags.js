...
(function (factory) {
	...
	var Tokenfield = function (element, options) {
		...
		if (this.$element.hasClass('form-control-lg')) this.$wrapper.addClass('form-control-lg')
		if (this.$element.hasClass('form-control-sm')) this.$wrapper.addClass('form-control-sm')
