...
namespace TomPIT.Data.Sql
{
	...
	internal static class Guard
	{
		...
		public static bool ArgumentNotNullOrEmptyString(string argumentValue, string argumentName)
		{
			...
			{
				throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, SR.StringCannotBeEmpty, argumentName));
			}
		...
		public static void ArgumentNotNegativeValue(int argumentValue, string argumentName)
		{
			if (argumentValue < 0)
			{
				throw new ArgumentOutOfRangeException(argumentName, argumentValue, string.Format(CultureInfo.CurrentCulture, SR.ArgumentCannotBeNegative, argumentName));
			}
		}
		...
		public static void ArgumentNotGreaterThan(double argumentValue, double ceilingValue, string argumentName)
		{
			...
			{
				throw new ArgumentOutOfRangeException(argumentName, argumentValue, string.Format(CultureInfo.CurrentCulture, SR.ArgumentCannotBeGreaterThanBaseline, argumentName, ceilingValue));
			}
		}
	}
}
