...
namespace TomPIT.Data.Sql
{
	...
	internal static class SqlCommandFactory
	{
		...
		public static IDbCommand CreateCommand(IDbConnection connection, string commandText)
		{
			...
			if (string.IsNullOrWhiteSpace(commandText)) throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, SR.StringCannotBeEmpty, "commandText"), "commandText");
