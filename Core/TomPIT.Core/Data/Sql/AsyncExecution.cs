		...
		private Task<TResult> ExecuteAsyncImpl(Task ignore)
		{
			...
			if (task == null)
			{
				throw new ArgumentException(
					 string.Format(CultureInfo.InvariantCulture, SR.TaskCannotBeNull, "taskFunc"),
					 "taskFunc");
			}
			...
			{
				throw new ArgumentException(
					 string.Format(CultureInfo.InvariantCulture, SR.TaskMustBeScheduled, "taskFunc"),
					 "taskFunc");
			}
...
#pragma warning restore 0618
	...
	internal class AsyncExecution : AsyncExecution<bool>
	{
		...
		private static Task<bool> StartAsGenericTask(Func<Task> taskAction)
		{
			...
			{
				throw new ArgumentException(
					 string.Format(CultureInfo.InvariantCulture, SR.TaskCannotBeNull, "taskAction"),
					 "taskAction");
			}
			...
			{
				throw new ArgumentException(
					 string.Format(CultureInfo.InvariantCulture, SR.TaskMustBeScheduled, "taskAction"),
					 "taskAction");
			}
