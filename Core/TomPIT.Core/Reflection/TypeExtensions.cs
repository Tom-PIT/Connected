...
namespace TomPIT.Reflection
{
    public static class TypeExtensions
    {
        ...
        {
            var editForbidden = !(pi.GetCustomAttribute<EditableAttribute>(true)?.AllowEdit ?? true);

            return IsBrowsable(pi) && (IsPrimitive(pi) || pi.PropertyType.IsValueType) && !editForbidden;
        }
