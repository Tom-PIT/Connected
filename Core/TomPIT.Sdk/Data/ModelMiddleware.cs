...
namespace TomPIT.Data
{
    public abstract class ModelMiddleware<T> : MiddlewareComponent, IModelMiddleware<T>
    {
        ...
        private IComponent Component => _component ??= Context.Tenant.GetService<ICompilerService>().ResolveComponent(this);
        private IModelConfiguration? Configuration => _configuration ??= Context.Tenant.GetService<IComponentService>().SelectConfiguration(Component.Token) as IModelConfiguration;
