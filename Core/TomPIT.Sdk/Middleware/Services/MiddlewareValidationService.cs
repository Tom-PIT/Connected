...
{
	internal class MiddlewareValidationService : MiddlewareObject, IMiddlewareValidationService
	{
		public MiddlewareValidationService(IMiddlewareContext context) : base(context)
		{
		}
