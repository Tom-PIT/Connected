...
namespace TomPIT.Middleware
{
    internal class MiddlewareServices : MiddlewareObject, IMiddlewareServices
    {
        ...
        private IMiddlewareWorkersService _workers = null;

        public MiddlewareServices(IMiddlewareContext context, ITransactionContext transactions) : base(context)
        {
        ...
        public IMiddlewareCachingService Cache
        {
            ...
            {
                if (_cache == null)
                    _cache = new MiddlewareCachingService(Context, Transactions);
        ...
        public IMiddlewareWorkersService Workers
        {
            get
            {
                if (_workers == null)
                    _workers = new MiddlewareWorkersService(Context);
