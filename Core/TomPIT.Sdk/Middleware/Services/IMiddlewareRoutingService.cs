...
namespace TomPIT.Middleware.Services
{
	public interface IMiddlewareRoutingService
	{
		...
		string ParseRoute([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey);
		string ParseRoute([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey, object parameters);
		string ParseRoute([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey, RouteValueDictionary parameters);
		...
		List<IBreadcrumb> QueryBreadcrumbs([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey);
		List<IBreadcrumb> QueryBreadcrumbs([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey, object parameters);
		List<IBreadcrumb> QueryBreadcrumbs([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey, RouteValueDictionary parameters);

		ISiteMapRoute SelectRoute([CIP(CIP.RouteKeyProvider)][AA(AA.RouteKeyAnalyzer)] string routeKey);
	}
}
