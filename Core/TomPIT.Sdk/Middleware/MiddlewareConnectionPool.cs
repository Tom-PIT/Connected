...
namespace TomPIT.Middleware
{
    internal class MiddlewareConnectionPool : List<DataConnectionDescriptor>, IDisposable
    {
        ...
        public async Task<IDataConnection> OpenConnection(string connection, ConnectionBehavior behavior, object arguments)
        {
            ...
            var con = await dataProvider.OpenConnection(Context, connectionString.Value, behavior);
