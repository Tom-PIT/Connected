...
{
	//	public abstract class MiddlewareIoC : IoCObject, IIoCContainer
	//	{
	...
	//		T IIoCContainer.GetValue<T>(string propertyName)
	//		{
	...
	//		void IIoCContainer.Invoke(string methodName, params object[] args)
	//		{
	...
	//		T IIoCContainer.Invoke<T>(string methodName, params object[] args)
	//		{
	//			var method = ResolveMethod(methodName);
	...
	//		void IIoCContainer.SetValue<T>(string propertyName, T value)
	//		{
	//			var property = ResolveProperty(this, propertyName.Split('.'));
