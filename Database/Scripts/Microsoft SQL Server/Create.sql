...
GO
ALTER TABLE [tompit].[feature] ADD CONSTRAINT [PK_feature] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[instance_endpoint] ADD CONSTRAINT [PK_instance_endpoint] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[resource_group] ADD CONSTRAINT [PK_resource_group] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[blob] ADD CONSTRAINT [PK_blob] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_blob_1] on [tompit].[blob]'
GO
CREATE NONCLUSTERED INDEX [IX_blob_1] ON [tompit].[blob] ([draft])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_blob] on [tompit].[blob]'
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_blob] ON [tompit].[blob] ([token])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[membership] ADD CONSTRAINT [PK_membership] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding constraints to [tompit].[membership]'
GO
ALTER TABLE [tompit].[membership] ADD CONSTRAINT [IX_membership] UNIQUE NONCLUSTERED  ([role], [user])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[service] ADD CONSTRAINT [PK_service] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[component] ADD CONSTRAINT [PK_component] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[environment_unit] ADD CONSTRAINT [PK_environment_unit] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[blob_content] ADD CONSTRAINT [PK_blob_content] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_blob_content] on [tompit].[blob_content]'
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_blob_content] ON [tompit].[blob_content] ([blob])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[log] ADD CONSTRAINT [PK_log] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[language] ADD CONSTRAINT [PK_language] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[message_subscriber] ADD CONSTRAINT [PK_message_subscriber] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[user] ADD CONSTRAINT [PK_user] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[service_string] ADD CONSTRAINT [PK_service_string] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[message_recipient] ADD CONSTRAINT [PK_message_recipient] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[message] ADD CONSTRAINT [PK_message] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[api_test] ADD CONSTRAINT [PK_api_test] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[message_topic] ADD CONSTRAINT [PK_message_topic] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[queue] ADD CONSTRAINT [PK_queue] PRIMARY KEY NONCLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_queue_1] on [tompit].[queue]'
GO
CREATE NONCLUSTERED INDEX [IX_queue_1] ON [tompit].[queue] ([pop_receipt])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[setting] ADD CONSTRAINT [PK_setting] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[user_state] ADD CONSTRAINT [PK_user_state] PRIMARY KEY CLUSTERED  ([user_id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[permission] ADD CONSTRAINT [PK_permission] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[event] ADD CONSTRAINT [PK_event] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[worker] ADD CONSTRAINT [PK_worker] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[auth_token] ADD CONSTRAINT [PK_auth_token] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[environment_var] ADD CONSTRAINT [PK_environment_var] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[role] ADD CONSTRAINT [PK_role] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
GO
ALTER TABLE [tompit].[audit] ADD CONSTRAINT [PK_audit] PRIMARY KEY CLUSTERED  ([id])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_audit] on [tompit].[audit]'
GO
CREATE NONCLUSTERED INDEX [IX_audit] ON [tompit].[audit] ([category])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_audit_1] on [tompit].[audit]'
GO
CREATE NONCLUSTERED INDEX [IX_audit_1] ON [tompit].[audit] ([event])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Creating index [IX_audit_2] on [tompit].[audit]'
GO
CREATE NONCLUSTERED INDEX [IX_audit_2] ON [tompit].[audit] ([primary_key])
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
